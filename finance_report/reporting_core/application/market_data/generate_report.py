...
class GeneratePriceReportUseCase(UseCase[ReportRequested, PriceReport | None]):
    def __init__(self, market_data_provider: MarketDataProvider, uow: UnitOfWork, windows: list[Window]) -> None:
